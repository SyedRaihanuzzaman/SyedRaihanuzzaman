...
✨ Focused on scalable mobile architecture and clean code principles
🎓 BSc in CSE — Daffodil International University (CGPA: 3.40)
📍 Mohammadpur, Dhaka
...
- 🔌 **Real-Time Systems:** Developed WebSocket-based chat for AI chatbot and 1:1 messaging
- 🤖 **ML Integration:** Engineered face recognition and NID document verification using machine learning
- ☁️ **Cloud Services:** Integrated Firebase FCM, push notifications, and cloud storage
- 🔗 **API Architecture:** Built scalable REST API layers using Dio and HTTP
- 📷 **Hardware Integration:** Leveraged Camera, Microphone, and Audio APIs for interactive features
...
- 🔄 Menstrual cycle tracking with analytics
- 🏋️ Personalized fitness & nutrition modules
- 🤖 AI chatbot for health guidance
- 📚 Peariipedia educational content library
...
Verified B2B networking platform for secure professional connections:
- ✅ Email OTP + document identity verification
- 🔄 Dynamic Personal/Business profile switching
- 💬 Real-time chat (WebSocket + Django Channels + FCM)
- 🏪 Offers & Needs marketplace with proposal system
- 🔍 Advanced business search & follow system
...
## 📚 Currently Learning
<p align="center">
<img src="https://img.shields.io/badge/GetX-State%20Management-8A2BE2?style=for-the-badge&logo=flutter&logoColor=white"/>
...
## 🎯 GitHub Metrics
<p align="center">
<img src="https://komarev.com/ghpvc/?username=SyedRaihanuzzaman&color=blue&style=flat-square&label=Profile+Views"/>
</p>
